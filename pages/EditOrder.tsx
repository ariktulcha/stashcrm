    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <button onClick={onCancel} className="text-blue-600 hover:underline">חזור לרשימת הזמנות</button>
        </div>
      </div>
    );
  }
  ...
  if (!canEdit) {
    return (
      <div className="max-w-4xl mx-auto h-full flex flex-col items-center justify-center">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mb-2">לא ניתן לערוך הזמנה זו</h2>
        <p className="text-slate-600 mb-4">הזמנות במצב {ORDER_STATUS_LABELS[order.status]} לא ניתנות לעריכה</p>
        <button onClick={onCancel} className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
          חזור
        </button>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl mx-auto h-full flex flex-col">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-slate-800">עריכת הזמנה #{order.order_number}</h2>
          <p className="text-slate-500 text-sm">עריכת פרטי הזמנה</p>
        </div>
      </div>
        ...
        {currentStep === 5 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="text-center mb-6">
               ...
               <p className="text-slate-500">אנא וודא שהכל תקין לפני השמירה</p>
            </div>
      ...
      {/* Create Customer Modal - Same as CreateOrder */}
      <Modal
